...
contract LW3Punks is ERC721Enumerable, Ownable {
    ...
    // total number of the tokenIds minted
     ...
     * name in our case is 'LW3Punks' and synbol is 'LW3P'.
    ...
    function tokenURI(
        ...
        /**
         * Here it checks if the length of he baseURI is greater than 0, if it is return the baseURI and attach
    ...
    /**
     * @dev withdraw send all the ether in the contract to the owner of the contract
     */
